...
const about_us_1 = () => {
    ...
    <>
      ...
      {/* Banner Section */}
      <section className="banner-section section--sm" style={{backgroundImage: 'url(/images/oil_shipment.jpg)'}}>
            ...
            <div className="col-lg-6 col-xxl-5">
              <div className="section__gap-bottom pb-lg-0 position-sticky top-0">
                ...
                <h2 className="mt-2 mb-4">
                  {" "}
                  Swift Production and Exceptional Services{" "}
                </h2>
                <p className="mb-5">
                  {" "}
                  Leveraging advanced and current technologies, we harness efficiency to expedite the preparation of substantial shipments within tight timelines. Our overarching mission is centered on meeting customer requirements through the production of top-tier quality products, coupled with the delivery of unparalleled services.{" "}
                </p>
                <p className="mb-8">
                  {" "}
                  Founded in 2023, Al-Tafkeer Al-Hadeth Oil Trading Company is led by a team of seasoned managers with over three decades of collective experience in the oil, gas, petrochemicals, and refinery sectors. Hailing from the United States, Canada, Iran, and the United Arab Emirates, our expertise spans identification, exploration, and drilling services.{" "}
                </p>
                <Link
                  href="contact-us-1"
